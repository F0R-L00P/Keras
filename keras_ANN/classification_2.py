...
from keras.models import load_model # to saved model
...
# to save file will do so as h5 extension in the directory location
model.save('iris_classifier.h5')

# import the model
trained_classifier = load_model('iris_classifier.h5')