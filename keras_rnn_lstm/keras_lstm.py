...
# building function that for given column, 
# it will iterate over each row and embed sentences
...
target_train_data = datasets.Dataset.from_dict(
    {'train_embeddings': embed_list})

# concatenate the embeddings dictionary to huggingface dictionary
new_dataset = datasets.concatenate_datasets(
    [dataset['train'], target_train_data], axis=1)
